      ...
      content: (
        <div id="hard-skills" className="text-center">
          <p className="roboto text-gray">
            Depuis plusieurs années maintenant, j'ai pu apprendre de façon autodidacte plusieurs
            logiciels, langages, frameworks ...
          </p>
          <div className="hard-skills-icons ">
            <div>
              ...
              <img
                ...
                title="Illustrator"
                src="assets/img/iconeillustrator.png"
              />
              ...
              <img
                alt="icone Premiere pro"
                title="Premiere Pro"
                src="assets/img/adobe-premiere-cc.svg"
              />
              <img
                alt="icone After Effect"
                title="After Effect"
      ...
      content: (
        <div id="soft-skills" className="container-fluid text-center">
          <div id="info-soft-skills">
            <p>
              Les différents postes que j'ai occupé m'ont permis de forger chacuns de mes Soft
              Skills.
            </p>
          </div>
    ...
    },
    {
      ...
      content: (
        <div id="project" className="text-center text-gray roboto">
          ...
          Illustration
          <br />
          Animation video After Effect
          <br />
          Affiche print
          <br />
          Site internet
          <br />
          Identité visuelle Twitch
        </div>
      ),
    },
  ];
