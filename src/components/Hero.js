    ...
    <Container fluid id="hero" className="ps-3 pe-3">
      ...
      <div id="hero-info" className="text-gray">
        ...
        <p className="text-gray roboto">
          Étudiante de 24 ans située autour de Caen, passionnée par tout ce qui touche qu domaine de
          l'informatique et plus partclièrement par la création digitale.
        </p>

        <div
          id="hero-contact"
          className="d-flex flex-row justify-content-between align-items-center  roboto"
        >
          <div>
